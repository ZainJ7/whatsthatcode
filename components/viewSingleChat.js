...
export default class ViewSingleChat extends Component {
  ...
  fetchMessages = async (chat_id) => { //set interval 3 sec
    try {
      const { chat_id } = this.props.route.params;
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.addUserButton} onPress={() => this.props.navigation.navigate('AddOrDeleteUser', { chat_id: chat_id })}>
